...
| `cpu` | ISA MIPS III intérprete, COP0, excepciones; TLB walk pendiente |
...
- **Unitarios:** CPU opcodes, bus endianness, DMA, scheduler.
- **Integración:** homebrew mínimos en `roms/` (no en git).
